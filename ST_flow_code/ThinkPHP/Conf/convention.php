...
return  array(
    ...
    #开发数据库
    'DB_TYPE'               =>  'mysql',     // 数据库类型
    'DB_HOST'               =>  'stflowdevout01.mysql.rds.aliyuncs.com', // 服务器地址  112.74.108.103
    'DB_NAME'               =>  'samton_flow_basic',          // 数据库名
    'DB_USER'               =>  'flow_db_admin',      // 用户名
    'DB_PWD'                =>  'flow_dev_admin_02',          // 密码  samtonmysql@test2016
     


    'DB_PORT'               =>  '3306',        // 端口
    'DB_PREFIX'             =>  't_flow_',    // 数据库表前缀
