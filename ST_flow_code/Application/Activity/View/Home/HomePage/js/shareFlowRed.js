				       ...
				       var accuracy = res.accuracy; // 位置精度
						$.ajax({
							...
							localStorage.setItem("positionstatue",repData.status);
								...
								{
									var url = "/index.php/Activity/Index/active_location/user_id/"+user_id+"/user_type/"+user_type+"/aid/"+user_activity_id +"/latitude/"+repData.data.latitude+"/longitude/"+repData.data.longitude;
									//alert(url);
									window.location = url;
								}
							},
