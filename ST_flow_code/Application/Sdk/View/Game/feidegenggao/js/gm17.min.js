...
function init() {
	...
	dvid = 0;- 1 < e.indexOf("Android") && (dvid = 1, 4 <= Math.floor(navigator.userAgent.substr(e.indexOf("Android") + 8, 1)) && (dvid = 2));
	- 1 < e.indexOf("iPad") && (dvid = 3);
	- 1 < e.indexOf("iPhone") && (dvid = 4, 2 <= window.devicePixelRatio && (dvid = 5, 568 == window.screen.height && (dvid = 5)));
	wdpr = 1;
	
	chf2.innerHTML = '<canvas id="gcvs" width='+width+' height='+heigth+'></canvas>';
	...
	- 1 < document.URL.indexOf("page") ? (e = ["img/title_jmp_nolink.jpg",
	"img/cs_jmp.gif",
	"img/cs_jmp_bg.jpg",
	"img/cs_jmp_nolink.png"],
	canvas.style.backgroundImage = "url(" + role + "img/title_jmp_nolink.jpg)",
	shms1 = "Browser game[SKY JUMP] SCORE=",
	shms2 = "Browser game[SKY JUMP]",
	shms3 = "Why don't you get useful tips by sharing this game to your friends?",
	shms4 = "Why don't you get useful items by sharing this game to your friends?") : -1 < e.indexOf("ja") ? (e = ["img/title_jmp_jp.jpg",
	"img/cs_jmp.gif",
	"img/cs_jmp_bg.jpg",
	"img/cs_jmp_jp.png"],
	canvas.style.backgroundImage = "url(skj/title_jmp_jp.jpg)",
	shms1 = "�����ɗV�ׂ�u���E�U�Q�[���uSKY JUMP�v SCORE=",
	shms2 = "�����ɗV�ׂ�u���E�U�Q�[���uSKY JUMP�v",
	shms3 = "�F�B�Ƃ��̃Q�[�����V�F�A���āA�𗧂�TIPS���Q�b�g���悤�I",
	shms4 = "�F�B�Ƃ��̃Q�[�����V�F�A���āA�A�C�e�����Q�b�g���悤�I") : (e = ["img/title_jmp.jpg",
	"img/cs_jmp.gif",
	"img/cs_jmp_bg.jpg",
	"img/cs_jmp.png"],
	canvas.style.backgroundImage = "url(" + role + "img/title_jmp.jpg)",
	shms1 = "Browser game[SKY JUMP] SCORE=",
	shms2 = "Browser game[SKY JUMP]",
	shms3 = "Why don't you get useful tips by sharing this game to your friends?",
...
function lp() {
	...
	case 1:
		...
		37 < wj && (wj = 37);
		1 < stti1 ? ctx.clearRect(19, 0, 301, windowHeight) : ctx.drawImage(img2, 0, wbgy | 0, 286, windowHeight-20, 17, 0, 286, windowHeight-35);
		wbgy -= wj / 23;
		0 > wbgy && (wbgy = 0);
		ctx.drawImage(img7, 626, twy | 0, 22, windowHeight-35, 0, 0, 22, windowHeight-35);
		ctx.drawImage(img7, 648, twy | 0, 22, windowHeight-35, 298, 0, 22, windowHeight-35);
		twy -= wj / 3;
		0 > twy && (twy += 104);
		for (e = m - 1; 0 <= e; e--) by[e] += wj,
		spt2(bc[e] + 4, bx[e], by[e]),
		390 < by[e] && rblk(e, 1); - 1 != sfcy && (sfcy += wj * (0 == scc), spt(scf, 0, sfcy), 323 < my && 0 < mj ? (sfcy = my + 42, 374 < my && (mj = -18, 0 < scc && (scc = 0, sfct = windowHeight))) : (sfcy += (sfct - sfcy) / 5, windowHeight == sfct && 415 < sfcy && (sfcy = -1)), 0 < scc && scc--);
		...
		scs(2, 3, scr_p);
		0 < spafwt && spafwt--;
		scr_m > brdc && 0 == brd && 0 == spafwt && (brdc += 1700, 2500 < brdc && (brdc = 9999), brd = 2, bdx = 160 < mx ? 20 : 236, bdy = windowHeight, bds = 1, bdj = 12);
		switch (fvan) {
		case 0:
		...
		if (0 < pcfi) {
			...
			1 == t.l && (t.x += t.sx, t.y += t.sy, t.sx *= t.zx, t.sy += t.zy, t.a -= .1, u = t.a, 1 < u && (u = 1), .1 > t.a || windowWidth < t.x || -18 > t.x || windowHeight-35 < t.y ? (t.l = 0, delete pcf[e]) : (ctx.globalAlpha = u, spt(13 + 3 * t.c + t.t, t.x, t.y)), o++);
			0 == o && (pcf = {},
			pcfi = 0);
			ctx.globalAlpha = 1
		}
		...
		374 < my && (1 < stti3 && -1 == sfcy && 62 != scf ? (mj = -18, scf = 62, sfcy = 415, sfct = 365, scc = 30) : windowHeight < my && (200 > scr_m ? mj = -18 : 4 != fak && (gmovs(), my = 417, fanf4 = 60)));
		...
		if (tm != mt && 0 < tm) {
			...
			flt = 0;
			200 < scr_m && 0 == scc && (mc = 2, sfct = windowHeight, 400 < scr_m && (mc = 3, 1e3 < scr_m && (mc = 4)));
		...
		break;
	case 2:
		ctx.drawImage(bcv2.canvas, 0, 0, windowWidth, windowHeight, 0, 0, windowWidth, windowHeight),
		o = 3 * fac,
		102 < o && (o = 102),
		...
		ctx.globalAlpha = 1,
		fac++,
		35 < fac && (45 > fac ? e = .1 * (fac - 35) : (0 == gmovcl && (gmovcl = 1), ctx.drawImage(img2, 0, wbgy | 0, 286, windowHeight-35, 17, 0, 286, windowHeight-35), ctx.drawImage(img7, 626, twy | 0, 22, windowHeight-35, 0, 0, 22, windowHeight-35), ctx.drawImage(img7, 648, twy | 0, 22, windowHeight-35, 298, 0, 22, windowHeight-35), ctx.globalAlpha = .5, ctx.fillStyle = "#000;", ctx.fillRect(0, 0, windowWidth, windowHeight), ctx.globalAlpha = 1, null, null, null, spt(93, 7, 67), spt(94, 0, 371), scs(99, String(scr_m).length, scr_m), scs(98, String(bstscr).length, bstscr), bstscr == scr_m && spt(87, 20, 145), 1 == gtips && spt(90, 75, 296), 1 < gmsts && (spt(90, 185, 296), 2 < gmsts && spt(90, 271, 296)), 1 == tipon && spt(92, 14, 6), e = .1 * (55 - fac), 0 > e && (e = 0)), ctx.globalAlpha = e, ctx.fillStyle = "#000;", ctx.fillRect(0, 0, windowWidth, windowHeight), ctx.globalAlpha = 1)
	}
}
onload = function() {
	ldri = 0;
