...
function init() {
	...
	wdpr = 1;
	chf2.innerHTML = '<canvas id="gcvs" width="windowWidth" height="416"></canvas>';
	...
	iw = [0, 32, 32, 32, 32, 40, 40, 40, 40, 33, 33, 33, 33, 18, 18, 18, 18, 18, 18, 18, 18, 18, 18, 18, 18, 290, windowWidth, 294, 58, 48, 58, 58, 31, 64, 64, 64, 64, 44, 80, 30, 31, windowWidth, 50, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 310, 113, 110, 308, 260, 22, 22, 260, 17, windowWidth, 28, 202, 0, 0, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 76, 0, 0, 0, 0, 0, 306, windowWidth];
...
function gmovs() {
	bcv2.drawImage(ctx.canvas, 0, 0, windowWidth, windowHeight, 0, 0, windowWidth, windowHeight);
	s = 2;
	tcd = fac = 0;
	scr_m |= 0;
...
function lp() {
	...
	case 1:
		...
		if (0 < pcfi) {
			...
			1 == t.l && (t.x += t.sx, t.y += t.sy, t.sx *= t.zx, t.sy += t.zy, t.a -= .1, u = t.a, 1 < u && (u = 1), .1 > t.a || windowWidth< t.x || -18 > t.x || 399 < t.y ? (t.l = 0, delete pcf[e]) : (ctx.globalAlpha = u, spt(13 + 3 * t.c + t.t, t.x, t.y)), o++);
			0 == o && (pcf = {},
			pcfi = 0);
			ctx.globalAlpha = 1
		}
		...
		break;
	case 2:
		ctx.drawImage(bcv2.canvas, 0, 0, windowWidth, 416, 0, 0, windowWidth, 416),
		o = 3 * fac,
		102 < o && (o = 102),
		...
		ctx.globalAlpha = 1,
		fac++,
		35 < fac && (45 > fac ? e = .1 * (fac - 35) : (0 == gmovcl && (gmovcl = 1), ctx.drawImage(img2, 0, wbgy | 0, 286, 399, 17, 0, 286, 399), ctx.drawImage(img7, 626, twy | 0, 22, 399, 0, 0, 22, 399), ctx.drawImage(img7, 648, twy | 0, 22, 399, 298, 0, 22, 399), ctx.globalAlpha = .5, ctx.fillStyle = "#000;", ctx.fillRect(0, 0, windowWidth, 416), ctx.globalAlpha = 1, null, null, null, spt(93, 7, 67), spt(94, 0, 371), scs(99, String(scr_m).length, scr_m), scs(98, String(bstscr).length, bstscr), bstscr == scr_m && spt(87, 20, 145), 1 == gtips && spt(90, 75, 296), 1 < gmsts && (spt(90, 185, 296), 2 < gmsts && spt(90, 271, 296)), 1 == tipon && spt(92, 14, 6), e = .1 * (55 - fac), 0 > e && (e = 0)), ctx.globalAlpha = e, ctx.fillStyle = "#000;", ctx.fillRect(0, 0, windowWidth, 416), ctx.globalAlpha = 1)
	}
}
onload = function() {
	ldri = 0;
